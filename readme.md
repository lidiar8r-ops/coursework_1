...
Модуль **views**:
  ...
  - def events_operations(df: DataFrame, str_date: str, range_data: str = "M") -> dict:
    <details> 
    <summary>Строки документации </summary>Реализует набор функций и главную функцию, принимающую на вход строку с датой и второй необязательный параметр
    — диапазон данных.
...
details> 
  <summary> Функции, реализованные в том разделе (Нажмите, чтобы раскрыть)</summary>
